...
from utils import Trainer, display_result, verify_m2_setup, load_dataset, prepare_datasets, PATH, SIZE
...
class T5SummarizationTrainer(Trainer):
    ...
    def process(lines, max_length):
        ...
        for i, line in enumerate(lines, 1):
            result = summarize_simple_model(line, model, tokenizer, max_length)
    ...
    def _build_model(self):
        self.model = TFAutoModelForSeq2SeqLM.from_pretrained(self.model_name, from_pt=self.from_pt)
    ...
    def _setup_callbacks(self):
        ...
        if self.use_tqdm:
            callbacks.insert(0, TqdmCallback(verbose=1))
        return callbacks
